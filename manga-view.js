...
const notesAttachment = manga.notesAttachment?.data ? `<section class="notes-attachment"><p class="eyebrow">Attached notes</p><a href="${manga.notesAttachment.data}" download="${escapeHtml(manga.notesAttachment.name || 'manga-notes')}">${escapeHtml(manga.notesAttachment.name || 'Open attached notes')} ↗</a><small>${escapeHtml(manga.notesAttachment.type || 'File')}</small></section>` : '';
